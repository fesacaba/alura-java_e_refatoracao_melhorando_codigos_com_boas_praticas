...
public class AdopetConsoleApplication {
    ...
    private static boolean importarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            HttpResponse<String> response = sendPost(json, client, uri);
    ...
    private static HttpResponse<String> sendPost(JsonObject json, HttpClient client, String uri) throws IOException, InterruptedException {
    ...
    private static boolean listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        HttpClient client = HttpClient.newHttpClient();
        String uri = "http://localhost:8080/abrigos/" + idOuNome + "/pets";
        HttpResponse<String> response = sendGet(client, uri);
        int statusCode = response.statusCode();
    ...
    private static HttpResponse<String> sendGet(HttpClient client, String uri) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
